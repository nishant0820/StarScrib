...
An online platform for StarScrib, allowing users to browse products, add items to their cart, and complete purchases. The website also includes an admin dashboard for managing products, orders, and users.
