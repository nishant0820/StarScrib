  ...
  useEffect(() => {
    if (isOpen) {
      setMessages([
        { 
          sender: 'bot', 
          text: "Hello! I'm StarScrib's AI assistant. How can I help you find the perfect stationery today? You can ask me about products, prices, or categories.",
          id: Date.now()
        }
      ]);
          ...
          >
            <header className={cn(
              ...
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-semibold text-lg text-foreground">StarScrib Assistant</h3>
              </div>
